...
use womp_core::{apply_display_layout, get_global_config, get_profiles, save_current_display_layout};
...
fn main() {
    ...
    match &cli.command {
        ...
        Commands::Apply { profile_name } => {
            match apply_display_layout(profile_name, &global_config, cli.debug) {
